...
// eslint-disable-next-line @typescript-eslint/no-unnecessary-type-arguments -- this is mandatory since typescript 5.7.2
export class BinaryIO extends DataView<Uint8Array['buffer']> {
